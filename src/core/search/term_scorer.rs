...
mod tests {
    ...
    use crate::test::core::util::lucene_test_case::lucene_test_case_util::{
        ...
        new_searcher_with_leaf_reader, new_searcher_with_reader, new_text_field, random,
    };
    ...
    fn test_random_top_docs() -> Result<()> {
        ...
        for iter in 0..15 {
            ...
            let complete =
                searcher.search_with_collector_manager(query.clone(), &complete_manager)?;
            let top_scores =
            ...
            let complete = searcher
                .search_with_collector_manager(filtered_query.clone(), &complete_manager)?;
            let top_scores =
