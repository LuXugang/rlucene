...
pub trait ImpactsSource {
  ...
  /// [`advance(target)`](crate::core::search::doc_id_set_iterator::DocIdSetIterator::advance)
  ...
  /// [`doc_id()`](crate::core::search::doc_id_set_iterator::DocIdSetIterator::doc_id).
  ...
  /// and [`advance(target)`](crate::core::search::doc_id_set_iterator::DocIdSetIterator::advance)
  /// may not be called on targets that are less than `target`.
  fn advance_shallow(&mut self, target: i32) -> Result<()>;

  type Impacts<'a>: Impacts
  where
    Self: 'a;
