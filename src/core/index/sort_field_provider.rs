...
use crate::core::search::sort_field::{Provider, SortFiledBase};
use crate::core::search::sort_field_enum::SortFieldEnum;
use crate::core::search::sorted_numeric_sort_field::NumericProvider;
use crate::core::search::sorted_set_sort_field::SetProvider;
use crate::core::store::{DataInput, DataOutput};
use crate::core::util::error::lucene_error::{LuceneError, Result};

/// Reads or writes a named [`SortFieldEnum`] from a segment info file, used
/// to record index sorts.
pub trait SortFieldProvider {
  /// Reads a [`SortFieldEnum`] from serialized bytes.
...
/// Writes a [`SortFieldEnum`] to a [`DataOutput`].
pub fn write<DO>(sf: &SortFieldEnum, output: &mut DO) -> Result<()>
where
  DO: DataOutput,
{
