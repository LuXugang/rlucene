...
impl UnicodeUtil {
  pub const UNI_SUR_HIGH_START: i32 = 0xD800;
  pub const UNI_SUR_HIGH_END: i32 = 0xDBFF;
  pub const UNI_SUR_LOW_START: i32 = 0xDC00;
  pub const UNI_SUR_LOW_END: i32 = 0xDFFF;
  pub const MAX_UTF8_BYTES_PER_CHAR: i32 = 3;
