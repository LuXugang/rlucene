    ...
    fn read_bytes_with_buffer(
        ...
        match self {
            ...
            IndexInputEnum::Custom(inner) => {
                inner.read_bytes_with_buffer(b, offset, len, _use_buffer)
            },
        }
    }
...
mod tests {
    ...
    pub static READ_TEST_BYTES: &[u8] = &[
        0x80, 0x01, 0xFF, 0x7F, 0x80, 0x80, 0x01, 0x81, 0x80, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0x07,
        0xFF, 0xFF, 0xFF, 0xFF, 0x0F, 0xFF, 0xFF, 0xFF, 0xFF, 0x07, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0x7F, 0x06, b'L', b'u', b'c', b'e', b'n', b'e', 0x02, 0xC2, 0xBF, 0x0A,
        b'L', b'u', 0xC2, 0xBF, b'c', b'e', 0xC2, 0xBF, b'n', b'e', 0x03, 0xE2, 0x98, 0xA0, 0x0C,
        b'L', b'u', 0xE2, 0x98, 0xA0, b'c', b'e', 0xE2, 0x98, 0xA0, b'n', b'e', 0x04, 0xF0, 0x9D,
        0x84, 0x9E, 0x08, 0xF0, 0x9D, 0x84, 0x9E, 0xF0, 0x9D, 0x85, 0xA0, 0x0E, b'L', b'u', 0xF0,
        0x9D, 0x84, 0x9E, b'c', b'e', 0xF0, 0x9D, 0x85, 0xA0, b'n', b'e', 0x01, 0x00, 0x08, b'L',
        b'u', 0x00, b'c', b'e', 0x00, b'n', b'e',
    ];
