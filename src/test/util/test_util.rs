...
const BLOCK_STARTS: &[u32] = &[
    ...
    0xE000, 0xF900, 0xFB00, 0xFB50, 0xFE00, 0xFE10, 0xFE20, 0xFE30, 0xFE50,
...
const BLOCK_ENDS: &[u32] = &[
    ...
    0xF8FF, 0xFAFF, 0xFB4F, 0xFDFF, 0xFE0F, 0xFE1F, 0xFE2F, 0xFE4F, 0xFE6F,
...
impl TestUtil {
    ...
    pub fn next_long(r: &mut StdRng, start: i64, end: i64) -> i64 {
        ...
        if range <= BigInt::from(i32::MAX) {
            ...
            let augend =
                BigInt::from_f64(range.to_f64().unwrap() * r.random::<f64>())
                    .unwrap();
    ...
    pub fn random_unicode_string_with_length(
        random: &mut StdRng,
        max_length: usize,
    ) -> String {
