...
use crate::test::core::util::lucene_test_case::lucene_test_case_util::{random_from_seed, random_multiplier};
...
impl SeedPostings{
    pub fn new(
        ...
        let do_positions = IndexOptions::DocsAndFreqsAndPositions.cmp(&options).to_int() <= 0;
