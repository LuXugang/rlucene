...
impl LegacyBaseDocValuesFormatTestCase for TestLucene90DocValuesFormatMergeInstance {}
impl BaseDocValuesFormatTestCase for TestLucene90DocValuesFormatMergeInstance {}
impl BaseCompressingDocValuesFormatTestCase for TestLucene90DocValuesFormatMergeInstance {}
impl TestLucene90DocValuesFormatTests for TestLucene90DocValuesFormatMergeInstance {}

fn run_case<F>(f: F) -> Result<()>
where
  F: FnOnce(&TestLucene90DocValuesFormatMergeInstance, &mut StdRng) -> Result<()>,
{
  let mut random = random();
  let case = TestLucene90DocValuesFormatMergeInstance;
  f(&case, &mut random)
}
