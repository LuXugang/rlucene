...
///
/// - ImpactLength is the total length of CompetitiveFreqDelta and CompetitiveNormDelta pairs. CompetitiveFreqDelta and CompetitiveNormDelta are used to safely skip score calculation for uncompetitive documents; see [`CompetitiveImpactAccumulator`](crate::codecs::competitive_impact_accumulator::CompetitiveImpactAccumulator) for more details.
/// # Positions
///
