...
impl Decoder for BulkOperationPacked5 {
    ...
    fn decode_u64_to_i32(
        ...
        for _ in 0..iterations {
            ...
            values[values_offset + 12] =
                (((block0 & 15) << 1) | (block1 >> 63)) as i32;
            ...
            values[values_offset + 25] =
                (((block1 & 7) << 2) | (block2 >> 62)) as i32;
            ...
            values[values_offset + 38] =
                (((block2 & 3) << 3) | (block3 >> 61)) as i32;
            ...
            values[values_offset + 51] =
                (((block3 & 1) << 4) | (block4 >> 60)) as i32;

            for shift in (0..=55).rev().step_by(5) {
                values[values_offset + 52 + (55 - shift) / 5] =
                    ((block4 >> shift) & 31) as i32;
            }
            values_offset += 64;
        }
    }
