...
impl Decoder for BulkOperationPacked13 {
    fn decode_u64_to_i64(
        ...
        for _ in 0..iterations {
            ...
            values[values_offset] =
                (((block0 & 4095) << 1) | (block1 >> 63)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block1 & 2047) << 2) | (block2 >> 62)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block2 & 1023) << 3) | (block3 >> 61)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block10 & 3) << 11) | (block11 >> 53)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block11 & 1) << 12) | (block12 >> 52)) as i64;
            values_offset += 1;
    ...
    fn decode_u64_to_i32(
        ...
        for _ in 0..iterations {
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block0 & 4095) << 1) | (block1 >> 63)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block1 & 2047) << 2) | (block2 >> 62)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block2 & 1023) << 3) | (block3 >> 61)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block10 & 3) << 11) | (block11 >> 53)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block11 & 1) << 12) | (block12 >> 52)) as i32;
            values_offset += 1;
