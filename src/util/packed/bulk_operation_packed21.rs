...
#[derive(Default)]
pub(crate) struct BulkOperationPacked21;
impl Decoder for BulkOperationPacked21 {
    fn decode_u64_to_i64(
        ...
        for _ in 0..iterations {
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block6 & 127) << 14) | (block7 >> 50)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block7 & 255) << 13) | (block8 >> 51)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block8 & 511) << 12) | (block9 >> 52)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block9 & 1023) << 11) | (block10 >> 53)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block10 & 2047) << 10) | (block11 >> 54)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block11 & 4095) << 9) | (block12 >> 55)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block12 & 8191) << 8) | (block13 >> 56)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block13 & 16383) << 7) | (block14 >> 57)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block14 & 32767) << 6) | (block15 >> 58)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block15 & 65535) << 5) | (block16 >> 59)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block16 & 131071) << 4) | (block17 >> 60)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block17 & 262143) << 3) | (block18 >> 61)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block18 & 524287) << 2) | (block19 >> 62)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block19 & 1048575) << 1) | (block20 >> 63)) as i64;
            values_offset += 1;
    ...
    fn decode_u8_to_i64(
        ...
        for _ in 0..iterations {
            ...
            blocks_offset += 1;
            values[values_offset] = ((byte2 & 7) << 18)
                | (byte3 << 10)
                | (byte4 << 2)
                | (byte5 >> 6);
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] = ((byte7 & 1) << 20)
                | (byte8 << 12)
                | (byte9 << 4)
                | (byte10 >> 4);
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] = ((byte10 & 15) << 17)
                | (byte11 << 9)
                | (byte12 << 1)
                | (byte13 >> 7);
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                ((byte13 & 127) << 14) | (byte14 << 6) | (byte15 >> 2);
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] = ((byte15 & 3) << 19)
                | (byte16 << 11)
                | (byte17 << 3)
                | (byte18 >> 5);
            values_offset += 1;
    ...
    fn decode_u64_to_i32(
        ...
        for _ in 0..iterations {
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block6 & 127) << 14) | (block7 >> 50)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block7 & 255) << 13) | (block8 >> 51)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block8 & 511) << 12) | (block9 >> 52)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block9 & 1023) << 11) | (block10 >> 53)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block10 & 2047) << 10) | (block11 >> 54)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block11 & 4095) << 9) | (block12 >> 55)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block12 & 8191) << 8) | (block13 >> 56)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block13 & 16_383) << 7) | (block14 >> 57)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block14 & 32_767) << 6) | (block15 >> 58)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block15 & 65_535) << 5) | (block16 >> 59)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block16 & 131_071) << 4) | (block17 >> 60)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block17 & 262_143) << 3) | (block18 >> 61)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block18 & 524_287) << 2) | (block19 >> 62)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block19 & 1_048_575) << 1) | (block20 >> 63)) as i32;
            values_offset += 1;
