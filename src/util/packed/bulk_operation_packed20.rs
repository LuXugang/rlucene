...
impl Decoder for BulkOperationPacked20 {
    fn decode_u64_to_i64(
        ...
        for _ in 0..iterations {
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block1 & 255) << 12) | (block2 >> 52)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block2 & 4095) << 8) | (block3 >> 56)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block3 & 65_535) << 4) | (block4 >> 60)) as i64;
            values_offset += 1;
    ...
    fn decode_u64_to_i32(
        ...
        for _ in 0..iterations {
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block1 & 255) << 12) | (block2 >> 52)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block2 & 4095) << 8) | (block3 >> 56)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block3 & 65_535) << 4) | (block4 >> 60)) as i32;
            values_offset += 1;
