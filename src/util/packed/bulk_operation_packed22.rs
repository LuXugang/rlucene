...
impl Decoder for BulkOperationPacked22 {
    fn decode_u64_to_i64(
        ...
        for _ in 0..iterations {
            ...
            values[values_offset] =
                (((block0 & 1_048_575) << 2) | (block1 >> 62)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block1 & 262_143) << 4) | (block2 >> 60)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block2 & 65_535) << 6) | (block3 >> 58)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block3 & 16_383) << 8) | (block4 >> 56)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block4 & 4_095) << 10) | (block5 >> 54)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block5 & 1_023) << 12) | (block6 >> 52)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block6 & 255) << 14) | (block7 >> 50)) as i64;
            values_offset += 1;
    ...
    fn decode_u8_to_i64(
        ...
        for _ in 0..iterations {
            ...
            blocks_offset += 1;
            values[values_offset] = ((byte2 & 3) << 20)
                | (byte3 << 12)
                | (byte4 << 4)
                | (byte5 >> 4);
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] = ((byte5 & 15) << 18)
                | (byte6 << 10)
                | (byte7 << 2)
                | (byte8 >> 6);
            values_offset += 1;
    ...
    fn decode_u64_to_i32(
        ...
        for _ in 0..iterations {
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block0 & 0xFFFFF) << 2) | (block1 >> 62)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block1 & 0x3FFFF) << 4) | (block2 >> 60)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block2 & 0xFFFF) << 6) | (block3 >> 58)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block3 & 0x3FFF) << 8) | (block4 >> 56)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block4 & 0xFFF) << 10) | (block5 >> 54)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block5 & 0x3FF) << 12) | (block6 >> 52)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block6 & 0xFF) << 14) | (block7 >> 50)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block7 & 0x3F) << 16) | (block8 >> 48)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block8 & 0xF) << 18) | (block9 >> 46)) as i32;
            values_offset += 1;
