...
impl Decoder for BulkOperationPacked11 {
    ...
    fn decode_u64_to_i64(
        ...
        for _ in 0..iterations {
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block5 & 1023) << 1) | (block6 >> 63)) as i64;
            values_offset += 1;
    ...
    fn decode_u8_to_i64(
        ...
        for _ in 0..iterations {
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((byte2 & 3) << 9) | (byte3 << 1) | (byte4 >> 7)) as i64;
            values_offset += 1;

            let byte5 = blocks[blocks_offset] as u64;
            blocks_offset += 1;
            values[values_offset] =
                (((byte4 & 127) << 4) | (byte5 >> 4)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((byte6 & 1) << 10) | (byte7 << 2) | (byte8 >> 6)) as i64;
            values_offset += 1;
    ...
    fn decode_u64_to_i32(
        ...
        for _ in 0..iterations {
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block5 & 1023) << 1) | (block6 >> 63)) as i32;
            values_offset += 1;
