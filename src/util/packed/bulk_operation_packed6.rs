...
impl Decoder for BulkOperationPacked6 {
    ...
    fn decode_u64_to_i64(
        ...
        for _ in 0..iterations {
            ...
            values[values_offset + 10] =
                (((block0 & 15) << 2) | (block1 >> 62)) as i64;
