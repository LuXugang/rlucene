...
impl Decoder for BulkOperationPacked18 {
    fn decode_u64_to_i64(
        ...
        for _ in 0..iterations {
            ...
            values[values_offset] =
                (((block0 & 1_023) << 8) | (block1 >> 56)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block2 & 4_095) << 6) | (block3 >> 58)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block4 & 16_383) << 4) | (block5 >> 60)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block6 & 65_535) << 2) | (block7 >> 62)) as i64;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block7 & 255) << 10) | (block8 >> 54)) as i64;
            values_offset += 1;
    ...
    fn decode_u64_to_i32(
        ...
        for _ in 0..iterations {
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block0 & 1_023) << 8) | (block1 >> 56)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block2 & 4_095) << 6) | (block3 >> 58)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block4 & 16_383) << 4) | (block5 >> 60)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block6 & 65_535) << 2) | (block7 >> 62)) as i32;
            values_offset += 1;
            ...
            blocks_offset += 1;
            values[values_offset] =
                (((block7 & 255) << 10) | (block8 >> 54)) as i32;
            values_offset += 1;
