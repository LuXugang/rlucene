...
/// [`LeafReader::get_norm_values(field: &str)`](crate::index::leaf_reader::LeafReader).  
...
/// [`NumericDocValuesField`](crate::document::numeric_doc_values_field::NumericDocValuesField)s and accessed at query time via
/// [`LeafReader::get_numeric_doc_values(field: &str)`](crate::index::leaf_reader::LeafReader), though such logic should live
