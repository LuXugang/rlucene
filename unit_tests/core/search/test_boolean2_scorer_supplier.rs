...
fn test_conjunction_cost() -> Result<()> {
  ...
  let dummy_searcher = crate::test::support::core::util::dummy_index_searcher(
    crate::test::support::core::util::dummy_directory()?,
  )?;
...
fn test_duel_cost() -> Result<()> {
  ...
  let dummy_dir = crate::test::support::core::util::dummy_directory()?;
  let dummy_searcher = crate::test::support::core::util::dummy_index_searcher(dummy_dir)?;
  let dummy_lrc = &dummy_searcher.get_leaf_contexts()?[0];
