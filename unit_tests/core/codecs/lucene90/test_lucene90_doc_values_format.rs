...
use crate::test::support::core::index::base_compressing_doc_values_format_test_case::BaseCompressingDocValuesFormatTestCase;
use crate::test::support::core::index::base_doc_values_format_test_case::BaseDocValuesFormatTestCase;
...
mod lucene90_doc_values_format_tests {
  use crate::codecs_tests::lucene90::test_lucene90_doc_values_format::{
...
mod base_compressing_doc_values_format_test_case_tests {
  use crate::codecs_tests::lucene90::test_lucene90_doc_values_format::run_case;
  use crate::core::util::error::lucene_error::Result;
  use crate::test::support::core::index::base_compressing_doc_values_format_test_case::BaseCompressingDocValuesFormatTestCase;
...
trait TestLucene90DocValuesFormatTests: BaseCompressingDocValuesFormatTestCase {
    ...
    R: Rng + ?Sized,
  {
    ...
    let analyzer = crate::test::support::core::analysis::mock_analyzer::MockAnalyzer::new(random);
