...
#[derive(Clone)]
pub struct RandomDistanceCodec {
  delegate: DefaultCodec,
  points_in_leaf: usize,
}

impl RandomDistanceCodec {
  pub(crate) fn new(points_in_leaf: usize) -> Self {
    Self {
...
impl Codec for RandomDistanceCodec {
  ...
  type PointsFormat = RandomDistancePointsFormat;
  ...
  fn points_format(&self) -> Self::PointsFormat {
    RandomDistancePointsFormat {
      points_in_leaf: self.points_in_leaf,
    }
  }
...
impl Display for RandomDistanceCodec {
  fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
    Display::fmt(&self.delegate, f)
  }
}

pub struct RandomDistancePointsFormat {
  points_in_leaf: usize,
}

impl PointsFormat for RandomDistancePointsFormat {
