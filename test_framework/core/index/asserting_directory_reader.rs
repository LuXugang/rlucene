...
struct AssertingSubReaderWrapper;
  ...
  LR: LeafReader,
{
  ...
  fn wrap(&self, reader: LR) -> Result<Self::LeafReader2> {
    AssertingLeafReader::new(reader)
  }
}

/// A [`DirectoryReader`] that wraps all its sub-readers with [`AssertingLeafReader`].
pub struct AssertingDirectoryReader<DR>
where
  DR: DirectoryReader,
  DR::LeafReader: Clone,
{
  in_: DR,
  base: BaseCompositeReaderBase<AssertingLeafReader<DR::LeafReader>>,
  index_base: IndexReaderBase,
}

impl<DR> AssertingDirectoryReader<DR>
where
  DR: DirectoryReader,
  DR::LeafReader: Clone,
{
...
impl<DR> BaseCompositeReader for AssertingDirectoryReader<DR>
where
  DR: DirectoryReader,
  DR::LeafReader: Clone,
{
...
impl<DR> CompositeReader for AssertingDirectoryReader<DR>
where
  DR: DirectoryReader,
  DR::LeafReader: Clone,
{
  type LeafReader = AssertingLeafReader<DR::LeafReader>;
  ...
  fn to_string(&self) -> String {
    format!("AssertingDirectoryReader({})", self.in_.to_string())
  }
}

impl<DR> IndexReader for AssertingDirectoryReader<DR>
where
  DR: DirectoryReader,
  DR::LeafReader: Clone,
{
...
impl<DR> Display for AssertingDirectoryReader<DR>
where
  DR: DirectoryReader,
  DR::LeafReader: Clone,
{
...
impl<DR> DirectoryReader for AssertingDirectoryReader<DR>
where
  DR: DirectoryReader,
  DR::LeafReader: Clone,
  <DR::DirectoryReader as CompositeReader>::LeafReader: Clone,
{
  type DirectoryReader = AssertingDirectoryReader<DR::DirectoryReader>;
...
impl<DR> FilterDirectoryReader for AssertingDirectoryReader<DR>
where
  DR: DirectoryReader,
  DR::LeafReader: Clone,
  <DR::DirectoryReader as CompositeReader>::LeafReader: Clone,
{
  ...
  type WrapDirectoryReader = AssertingDirectoryReader<DR::DirectoryReader>;
  ...
  fn do_wrap_directory_reader(
    ...
    in_.map(AssertingDirectoryReader::new).transpose()
  }
}
